  ...
  return (
    <div className="panel p-4">
      <div className="mb-3 flex items-center justify-between">
        <h3 className="font-terminal text-xl text-term">Command Belt</h3>
        ...
        {COMMANDS.map((c) => {
          ...
          return (
            <span
              ...
              className={`keycap ${
                isMastered ? 'border-term text-term' : started ? 'text-ink' : 'opacity-35'
              }`}
              style={isMastered ? { boxShadow: '0 0 8px rgba(61,220,132,0.4)' } : undefined}
            >
              {c.keys}
            </span>
          )
